...
public class LAPORAN_PENGGAJIAN extends javax.swing.JFrame {
    ...
    public LAPORAN_PENGGAJIAN() {
     ...
     private void setupUI() {
        ...
        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 18)); // Mengganti font dan ukuran
        pilihLaporan.setFont(new java.awt.Font("Segoe UI", 0, 14));
        tblLaporan.getTableHeader().setFont(new java.awt.Font("Segoe UI", 1, 12));
//        bCetak.setIcon(new ImageIcon(getClass().getResource("/icons/print.png"))); // Menambahkan ikon pada tombol cetak
//        bBatal.setIcon(new ImageIcon(getClass().getResource("/icons/cancel.png")));
//        jLabel6.setIcon(new ImageIcon(getClass().getResource("/icons/report.png"))); // Menambahkan ikon pada label judul
    }
    
     private void enablePegawaiFields(boolean enable) {
        laporanPerPegawai.setEnabled(enable);
    }
     
      private void enableTanggalFields(boolean enable) {
        periode1.setEnabled(enable);
        periode2.setEnabled(enable);
    }
      
      private void cetakLaporan(java.awt.event.ActionEvent evt) {
        try {
            switch (pilihLaporan.getSelectedIndex()) {
                case 0:
                    cetakLaporanPerPegawai();
                    break;
                case 1:
                    cetakLaporanPeriode();
                    break;
      ...
      private void cetakLaporanPerPegawai() {
        String nik = laporanPerPegawai.getText();
        // Add your code to generate report per employee
        System.out.println("Mencetak laporan per pegawai untuk NIK: " + nik);
    }
      
      private void cetakLaporanPeriode() {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        String startDate = sdf.format(periode1.getDate());
        String endDate = sdf.format(periode2.getDate());
        // Add your code to generate report for the given period
        System.out.println("Mencetak laporan dari " + startDate + " hingga " + endDate);
    }
      
      private void cetakSlipGaji() {
        // Add your code to generate salary slip
        System.out.println("Mencetak slip gaji");
    }
    ...
    private void initComponents() {
        ...
        laporanPerPegawai = new javax.swing.JTextField();
        jLabel9 = new javax.swing.JLabel();
        jLabel10 = new javax.swing.JLabel();
        periode2 = new com.toedter.calendar.JDateChooser();
        jLabel11 = new javax.swing.JLabel();
        slipGaji = new javax.swing.JTextField();
        ...
        jLabel8.setText("Laporan Per Pegawai");
        ...
        pilihLaporan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Laporan Per Pegawai", "Laporan Per Periode Tanggal", "Laporan Per Slip Gaji" }));
        ...
        jLabel9.setText("Laporan Per Periode Tanggal");

        jLabel10.setText("s/d");

        jLabel11.setText("Laporan Slip Gaji");
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(slipGaji, javax.swing.GroupLayout.PREFERRED_SIZE, 249, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addComponent(laporanPerPegawai, javax.swing.GroupLayout.PREFERRED_SIZE, 249, javax.swing.GroupLayout.PREFERRED_SIZE)))))
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(laporanPerPegawai, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(2, 2, 2)
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(periode2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jLabel11, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(slipGaji, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(67, 67, 67)
    ...
    private void pilihLaporanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pilihLaporanActionPerformed
        ...
        int selected = pilihLaporan.getSelectedIndex();
    switch (selected) {
        case 0: // Laporan Per Pegawai
            enablePegawaiFields(true);
            enableTanggalFields(false);
            break;
        case 1: // Laporan Per Periode Tanggal
            enablePegawaiFields(false);
            enableTanggalFields(true);
            break;
        case 2: // Laporan Slip Gaji
            enablePegawaiFields(false);
            enableTanggalFields(false);
            break;
        default:
    ...
    private javax.swing.JTextField laporanPerPegawai;
    ...
    private javax.swing.JTextField slipGaji;
